...
console.log(`List of students with scores above`, threshold);
...
const totalAmount = 562000000;
const interestRate = 5.6;
const year = 3;
const totalAmountEeceived = calculateInterest(totalAmount, interestRate, year);
console.log("Total amount received:", totalAmountEeceived);